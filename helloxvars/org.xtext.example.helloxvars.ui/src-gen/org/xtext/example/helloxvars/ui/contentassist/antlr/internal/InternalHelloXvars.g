...
:
(
{ before(grammarAccess.getModelAccess().getVarDeclarationsAssignment_1()); }
(rule__Model__VarDeclarationsAssignment_1)*
{ after(grammarAccess.getModelAccess().getVarDeclarationsAssignment_1()); }
)
...
{ before(grammarAccess.getModelAccess().getVarDeclarationsXVariableDeclarationParserRuleCall_1_0()); }
	ruleXVariableDeclaration{ after(grammarAccess.getModelAccess().getVarDeclarationsXVariableDeclarationParserRuleCall_1_0()); }
)
