...
public interface HelloXbasePackage extends EPackage
{
  ...
  /**
   * Returns the meta object for the containment reference '{@link org.xtext.example.helloxbase.helloXbase.Model#getImportSection <em>Import Section</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Import Section</em>'.
   * @see org.xtext.example.helloxbase.helloXbase.Model#getImportSection()
   * @see #getModel()
   * @generated
   */
