...
public class HelloXcoreSyntacticSequencer extends AbstractSyntacticSequencer {

	protected HelloXcoreGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (HelloXcoreGrammarAccess) access;
