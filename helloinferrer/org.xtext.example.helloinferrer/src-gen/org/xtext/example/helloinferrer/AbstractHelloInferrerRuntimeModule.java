...
/**
 * Manual modifications go to {org.xtext.example.helloinferrer.HelloInferrerRuntimeModule}
 */
 @SuppressWarnings("all")
public abstract class AbstractHelloInferrerRuntimeModule extends DefaultRuntimeModule {

	protected Properties properties = null;

	@Override
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "org/xtext/example/helloinferrer/HelloInferrer.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("org.xtext.example.helloinferrer.HelloInferrer");
	}
	
	public void configureFileExtensions(Binder binder) {
		if (properties == null || properties.getProperty(Constants.FILE_EXTENSIONS) == null)
			binder.bind(String.class).annotatedWith(Names.named(Constants.FILE_EXTENSIONS)).toInstance("helloinferrer");
	}
	
	// contributed by org.eclipse.xtext.generator.grammarAccess.GrammarAccessFragment
	public Class<? extends org.eclipse.xtext.IGrammarAccess> bindIGrammarAccess() {
		return org.xtext.example.helloinferrer.services.HelloInferrerGrammarAccess.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.IParser> bindIParser() {
		return org.xtext.example.helloinferrer.parser.antlr.HelloInferrerParser.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.antlr.IAntlrTokenFileProvider> bindIAntlrTokenFileProvider() {
		return org.xtext.example.helloinferrer.parser.antlr.HelloInferrerAntlrTokenFileProvider.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public Class<? extends org.eclipse.xtext.parser.antlr.Lexer> bindLexer() {
		return org.xtext.example.helloinferrer.parser.antlr.internal.InternalHelloInferrerLexer.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public com.google.inject.Provider<org.xtext.example.helloinferrer.parser.antlr.internal.InternalHelloInferrerLexer> provideInternalHelloInferrerLexer() {
		return org.eclipse.xtext.parser.antlr.LexerProvider.create(org.xtext.example.helloinferrer.parser.antlr.internal.InternalHelloInferrerLexer.class);
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public void configureRuntimeLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.parser.antlr.LexerBindings.RUNTIME)).to(org.xtext.example.helloinferrer.parser.antlr.internal.InternalHelloInferrerLexer.class);
	}
	...
	public Class<? extends org.eclipse.xtext.formatting.IFormatter> bindIFormatter() {
		return org.xtext.example.helloinferrer.formatting.HelloInferrerFormatter.class;
	}
	...
	public Class<? extends org.eclipse.xtext.xbase.jvmmodel.IJvmModelInferrer> bindIJvmModelInferrer() {
		return org.xtext.example.helloinferrer.jvmmodel.HelloInferrerJvmModelInferrer.class;
	}
