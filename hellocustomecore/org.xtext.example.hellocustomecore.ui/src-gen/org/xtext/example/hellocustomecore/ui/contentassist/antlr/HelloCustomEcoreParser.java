...
* generated by Xtext
*/
package org.xtext.example.hellocustomecore.ui.contentassist.antlr;
...
public class HelloCustomEcoreParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.xtext.example.hellocustomecore.ui.contentassist.antlr.internal.InternalHelloCustomEcoreParser createParser() {
		org.xtext.example.hellocustomecore.ui.contentassist.antlr.internal.InternalHelloCustomEcoreParser result = new org.xtext.example.hellocustomecore.ui.contentassist.antlr.internal.InternalHelloCustomEcoreParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getModelAccess().getHellosAssignment_1(), "rule__Model__HellosAssignment_1");
					...
					put(grammarAccess.getGreetingAccess().getExpressionAssignment_2(), "rule__Greeting__ExpressionAssignment_2");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.xtext.example.hellocustomecore.ui.contentassist.antlr.internal.InternalHelloCustomEcoreParser typedParser = (org.xtext.example.hellocustomecore.ui.contentassist.antlr.internal.InternalHelloCustomEcoreParser) parser;
