...
* generated by Xtext
*/
grammar InternalHelloCustomEcore;
...
:
(
{ before(grammarAccess.getModelAccess().getHellosAssignment_1()); }
(rule__Model__HellosAssignment_1)*
{ after(grammarAccess.getModelAccess().getHellosAssignment_1()); }
)
...
:
(
{ before(grammarAccess.getGreetingAccess().getGreetingKeyword_0()); }

	'Greeting' 

{ after(grammarAccess.getGreetingAccess().getGreetingKeyword_0()); }
)
...
:
(
{ before(grammarAccess.getGreetingAccess().getExpressionAssignment_2()); }
(rule__Greeting__ExpressionAssignment_2)
{ after(grammarAccess.getGreetingAccess().getExpressionAssignment_2()); }
)
...
:
(
{ before(grammarAccess.getModelAccess().getHellosHelloParserRuleCall_1_0()); }
	ruleHello{ after(grammarAccess.getModelAccess().getHellosHelloParserRuleCall_1_0()); }
)
...
:
(
{ before(grammarAccess.getGreetingAccess().getExpressionXExpressionParserRuleCall_2_0()); }
	ruleXExpression{ after(grammarAccess.getGreetingAccess().getExpressionXExpressionParserRuleCall_2_0()); }
)
