...
@parser::members {
    ...
    public InternalHelloCustomEcoreParser(TokenStream input, HelloCustomEcoreGrammarAccess grammarAccess) {
        this(input);
    ...
    protected String getFirstRuleName() {
   	...
   	@Override
   	protected HelloCustomEcoreGrammarAccess getGrammarAccess() {
...
(
		{ 
	        newCompositeNode(grammarAccess.getModelAccess().getHellosHelloParserRuleCall_1_0()); 
	    }
		lv_hellos_1_0=ruleHello		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getModelRule());
	        }
       		add(
...
(	otherlv_0='Greeting' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getGreetingAccess().getGreetingKeyword_0());
    }
(
(
		lv_name_1_0=RULE_ID
...
(
		{ 
	        newCompositeNode(grammarAccess.getGreetingAccess().getExpressionXExpressionParserRuleCall_2_0()); 
	    }
