...
* generated by Xtext
*/
package org.xtext.example.hellocustomecore.services;
...
@Singleton
public class HelloCustomEcoreGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class ModelElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cHellosAssignment_1 = (Assignment)cGroup.eContents().get(1);
		private final RuleCall cHellosHelloParserRuleCall_1_0 = (RuleCall)cHellosAssignment_1.eContents().get(0);
		...
		//hellos+=Hello*
		public Assignment getHellosAssignment_1() { return cHellosAssignment_1; }

		//Hello
		public RuleCall getHellosHelloParserRuleCall_1_0() { return cHellosHelloParserRuleCall_1_0; }
	...
	public class HelloElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "Hello");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class GreetingElements extends AbstractParserRuleElementFinder {
		...
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cGreetingKeyword_0 = (Keyword)cGroup.eContents().get(0);
		private final Assignment cNameAssignment_1 = (Assignment)cGroup.eContents().get(1);
		private final RuleCall cNameIDTerminalRuleCall_1_0 = (RuleCall)cNameAssignment_1.eContents().get(0);
		...
		//"Greeting"
		public Keyword getGreetingKeyword_0() { return cGreetingKeyword_0; }
	...
	@Inject
	public HelloCustomEcoreGrammarAccess(GrammarProvider grammarProvider,
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("org.xtext.example.hellocustomecore.HelloCustomEcore".equals(grammar.getName())) {
				return grammar;
			}
	...
	//Hello:
	//	"Hello" name=ID "!";
	public HelloElements getHelloAccess() {
		return (pHello != null) ? pHello : (pHello = new HelloElements());
	}
	
	public ParserRule getHelloRule() {
		return getHelloAccess().getRule();
	}
