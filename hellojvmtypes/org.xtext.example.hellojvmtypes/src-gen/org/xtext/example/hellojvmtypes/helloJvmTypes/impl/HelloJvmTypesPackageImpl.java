 ...
 * @generated
 */
public class HelloJvmTypesPackageImpl extends EPackageImpl implements HelloJvmTypesPackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.hellojvmtypes.helloJvmTypes.HelloJvmTypesPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private HelloJvmTypesPackageImpl()
  {
    super(eNS_URI, HelloJvmTypesFactory.eINSTANCE);
  }
   ...
   * 
   * <p>This method is used to initialize {@link HelloJvmTypesPackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static HelloJvmTypesPackage init()
  {
    if (isInited) return (HelloJvmTypesPackage)EPackage.Registry.INSTANCE.getEPackage(HelloJvmTypesPackage.eNS_URI);

    // Obtain or create and register package
    HelloJvmTypesPackageImpl theHelloJvmTypesPackage = (HelloJvmTypesPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof HelloJvmTypesPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new HelloJvmTypesPackageImpl());
    ...
    theHelloJvmTypesPackage.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theHelloJvmTypesPackage.freeze();

  
    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(HelloJvmTypesPackage.eNS_URI, theHelloJvmTypesPackage);
    return theHelloJvmTypesPackage;
  }
